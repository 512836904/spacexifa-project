...
<form id="fm" method="post" data-options="novalidate:true">
    <div class="functiondiv">
        <div>
            ...
            <input name="companyName" id="companyName" style="width:250px;" class="easyui-textbox"
    ...
    <div id="body">
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <input name="airflow" id="airflow" style="width:60px;" class="easyui-textbox"
                                       style="width:10px;" data-options="required:true"/>L/min
                            </td>
                        </tr>
                        <%--							<tr>--%>
        ...
        <div style="float:left;width:65%;margin-top:5px;">
            <fieldset>
                ...
                <div>
                    <table>
                        <tr>
                            <td class="leftTd" width="150">当前白名单版本：</td>
                            <td>
                                <input name="numVersion" id="numVersion" style="width:60px;" class="easyui-textbox"
        ...
        <div style="float:left;text-align:right;width:100%;margin-top:50px;">
            <a href="javascript:savePara();" class="easyui-linkbutton" iconCls="icon-savewps"
               style="border:1px solid #cbc9c9;">保存</a>
        </div>
    </div>
</form>
</body>
