...
<div id="body" style="height: 77%">
    ...
    <div id="dlg" class="easyui-dialog" style="width: 400px; height: 530px; padding:10px 20px" closed="true"
        ...
        <form id="fm" class="easyui-form" method="post" data-options="novalidate:true">
            ...
            <div class="fitem">
                ...
                <select class="easyui-combobox" name="typeId" id="tId"
            ...
            <div class="fitem">
                ...
                <select class="easyui-combobox" name="iId" id="iId"
                        data-options="required:true,editable:false"></select>
            </div>
            <div class="fitem">
                <lable><span class="required">*</span>生产厂商</lable>
                <select class="easyui-combobox" name="manuno" id="manuno"
                        data-options="required:true,editable:false"></select>
            </div>
            <div class="fitem">
                <lable><span class="required">*</span>采集序号</lable>
                <input type="hidden" id="validgid">
                <select class="easyui-combobox" name="gid" id="gid"
                        data-options="validType:['wmGatheridValidate'],multiple:false,required:true"></select>
    ...
    <!-- 删除 -->
    <div id="rdlg" class="easyui-dialog" style="width: 400px; height: 530px; padding:10px 20px" closed="true"
