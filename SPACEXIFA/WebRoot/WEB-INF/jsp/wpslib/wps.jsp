...
<div class="functiondiv">
    <div>
        ...
        <div>
            <input type="hidden" id="supergage_status">
            <input type="hidden" id="paramterId">
            ...
            <a href="javascript:supergageShowOrHide(1);" class="easyui-linkbutton" iconCls="icon-export">
...
<div id="body" style="height: 78%">
    ...
    <!-- 焊缝信息列表 -->
    <div id="dialogDiv" class="easyui-dialog" style="width: 1150px; height: 660px;" closed="true"
         buttons="#tdd-buttons">
        <div class="functiondiv">
            <div>
                <div style="float: left;">
        ...
        <div align="center">
            <a href="javascript:determine();" style="width: 13%;height: 40px" class="easyui-linkbutton"
    ...
    <!-- 新增电子跟踪卡 -->
    <div id="addTarckingCard" class="easyui-dialog" style="width: 1100px; height: 600px; padding:10px 20px"
         closed="true" buttons="#tdd-buttons">
        <form id="addTarckingCardfm" class="easyui-form" method="post" data-options="novalidate:true">
            <div style="width: 100%">
                <div class="fitem">
                    ...
                    <input class="easyui-textbox" name="SET_NUMBER" id="SET_NUMBER" data-options="required:true"/>
                    <lable><span class="required">*</span>工票编号：</lable>
                    <input class="easyui-textbox" name="workticket_number" id="workticket_number"
                           data-options="required:true"/>
                </div>
                <div class="fitem">
                    <lable><span class="required">*</span>零级图号：</lable>
                    <input class="easyui-textbox" name="PART_DRAWING_NUMBER" id="PART_DRAWING_NUMBER"
                           data-options="required:true"/>
                    <lable><span class="required">*</span>零件名：</lable>
                    <input class="easyui-textbox" name="PART_NAME" id="PART_NAME" data-options="required:true"/>
                    <lable><span class="required">*</span>工艺参数：</lable>
