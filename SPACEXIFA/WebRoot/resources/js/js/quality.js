...
function one_3(data) {
    ...
    loadSupergageCumulativeNumber(data,null);
}
...
function gobutton_3() {
    ...
    e.style.display = 'none';
    workstanders();
    loadSupergageCumulativeNumber(null,0);
}
...
function gobutton_4() {
    ...
    e.style.display = 'none';
    teamstanders();
    loadSupergageCumulativeNumber(null,1);
}
