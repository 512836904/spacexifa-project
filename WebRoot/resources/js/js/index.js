...
// 数据变化
    ...
    var dataAll = [
        {year: "当日", data: [20, 16, 14, 11, 9, 7, 3], people: ['张三', '张飞', '李伟', '张天', '宋龙', '胖虎', '刘伟']},
        {year: "当月", data: [2, 6, 4, 1, 9, 7, 3], people: ['张四', '王二麻', '李伟', '张天', '宋龙', '胖虎', '刘伟']}
    ];

    $("#L2").on("click", "button", function () {
        option.series[0].data = dataAll[$(this).index() - 1].data;
        option.yAxis[0].data = dataAll[$(this).index() - 1].people;
        option.yAxis[1].data = dataAll[$(this).index() - 1].data;
        myChart.setOption(option);
    });
})();
...
(function () {
    ...
    var dataAll = [
        {year: "当日", data1: [25, 45, 55, 25.2, 58,], data2: [835.07, 1256.78, 1632.57, 800, 1235.91,]},
        {year: "当月", data1: [21, 14, 49, 37, 23], data2: [435.07, 256.78, 632.57, 400, 1235.91,]}
    ];

    $("#L3").on("click", "button", function () {
        option.series[0].data = dataAll[$(this).index() - 1].data1;
        option.series[1].data = dataAll[$(this).index() - 1].data2;
        myChart.setOption(option);
    });
})();
...
(function () {
    ...
    var dataAll = [
        {year: "当日", data: [40, 65, 60, 58, 85, 20, 13]},
        {year: "当月", data: [50, 15, 30, 68, 35, 30, 13]}
    ];

    $("#M1").on("click", "button", function () {
        option.series[0].data = dataAll[$(this).index() - 1].data;
        myChart.setOption(option);
    });
...
(function () {
    ...
    var dataAll = [
        {year: "当日", data: [13, 16, 13, 11, 10, 8.5]},
        {year: "当月", data: [11, 6, 3, 11, 7, 16]}
    ];

    $("#M2").on("click", "button", function () {
        option.series[0].data = dataAll[$(this).index() - 1].data;
        option.series[1].data = dataAll[$(this).index() - 1].data.map(item => item + 0.53);
        option.series[2].data = dataAll[$(this).index() - 1].data;
...
(function () {
    ...
    var dataAll = [
        {year: "当日", data: [600, 843, 700, 854, 500, 1000]},
        {year: "当月", data: [300, 443, 700, 354, 800, 400]}
    ];
...
(function () {
    ...
    var dataAll = [
        {year: "当日", data: [64, 86, 40, 73, 56, 63, 41, 46, 90, 63, 81, 52]},
        {year: "当月", data: [34, 86, 40, 33, 56, 33, 41, 46, 30, 63, 81, 52]}
    ];
