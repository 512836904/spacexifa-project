...
<div class="functiondiv">
	<div>
		...
		<div>
			...
			<label>白名单版本：</label>
			<input class="easyui-textbox" name="numVersion" id="numVersion" readonly="readonly"/>
		</div>
	</div>
	<div>
		<div style="float: left;">
		...
		<div style="float: left;">
			...
			<a href="javascript:whiteListIssue();" title="已离职的焊工将不会进行下发" class="easyui-linkbutton" iconCls="icon-setwps">白名单下发</a>&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
	</div>
</div>

<!-- 焊机列表 -->
<div id="machineTables" class="easyui-dialog" style="width: 900px; height: 560px; padding:0px 20px;top: 0px;"
	 closed="true" buttons="#smdlg-buttons">
	<form id="smfm" class="easyui-form" method="post" data-options="novalidate:true">
		<span style="color: #cd0a0a;">已离职的焊工将不会进行下发！</span>
		<div class="fitem">
			<lable>工区筛选：</lable>
			<select class="easyui-combobox" name="workArea" id="workArea" data-options="editable:false"></select>
			<lable>班组筛选：</lable>
			<select class="easyui-combobox" name="organize" id="organize" data-options="editable:false"></select>
		</div>
		<table id="weldMachineTable" style="table-layout: fixed; width:100%;"></table>
	</form>
</div>

<!-- 白名单下发结果列表 -->
<div id="resultTables" class="easyui-dialog" style="width: 900px; height: 550px;padding:5px 10px 5px 10px;top: 5px;" closed="true"
	...
	<!-- 加载动画样式 -->
	<div id="tipDiv">
		<img align="center" style="width:50%;heigth: 50%;padding-left: 24%;" src="resources/images/load.gif">
...
<div id="body" style="height: 78%">
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px; height: 500px; padding:10px 20px" closed="true"
		...
		<form id="fm" class="easyui-form" method="post" data-options="novalidate:true"><br/>
			...
			<div class="fitem">
				...
				<input name="welderno" id="welderno" class="easyui-textbox"
					   data-options="validType:['checkNumber','welderValidate'],required:true">
			</div>
			<div class="fitem">
			...
			<div class="fitem">
				...
				<select class="easyui-combobox" name="leveid" id="leveid"
						data-options="required:true,editable:false"></select>
			</div>
			<div class="fitem">
				<lable><span class="required">*</span>资质</lable>
				<select class="easyui-combobox" name="quali" id="quali"
						data-options="required:true,editable:false"></select>
			</div>
			<div class="fitem">
				<lable><span class="required">*</span>部门</lable>
				<select class="easyui-combobox" name="owner" id="owner"
						data-options="required:true,editable:false"></select>
			</div>
			<div class="fitem">
				<lable>状态</lable>
				<select class="easyui-combobox" name="fstatus" id="fstatus"
						data-options="editable:false"></select>
			</div>
			<div class="fitem">
				<lable>离职状态：</lable>
				<select class="easyui-combobox" name="DIMISSIONSTATUS" id="DIMISSIONSTATUS"
						data-options="editable:false"></select>
			</div>
			<div class="fitem">
				<lable>备注</lable>
	...
	<!-- 删除 -->
	<div id="rdlg" class="easyui-dialog" style="width: 400px; height: 500px; padding:10px 20px" closed="true"
