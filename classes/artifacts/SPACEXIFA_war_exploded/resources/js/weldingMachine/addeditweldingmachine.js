...
//			$("#gid").html(str);
//			$("#gid").combobox();
			$("#gid").combobox("setValues", row.gid);
//		}
...
function saveWeldingMachine(){
	...
	var gatherId = $('#gid').combobox('getValues');
	var gatherStr = gatherId.join(",");
	...
	if(flag==1){
		messager = "新增成功！";
		url2 = url+"?tId="+tid+"&iId="+iid+"&sId="+sid+"&isnetworking="+isnetworking+"&manuno="+manuno+"&gatherId="+gatherStr;
	}else{
		messager = "修改成功！";
		url2 = url+"&tId="+tid+"&iId="+iid+"&sId="+sid+"&isnetworking="+isnetworking+"&manuno="+manuno+"&gatherId="+gatherStr;
	}
