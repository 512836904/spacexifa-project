...
(function () {
    ...
    var option = {
        ...
        series: [{
            ...
            color: ['#FDC008', '#00C077', '#FF581D', '#0F77FF'],
            data: [
                {value: 30, name: '工作', id: 0},
                {value: 50, name: '待机', id: 1},
                {value: 5, name: '故障', id: 2},
                {value: 30, name: '关机', id: 3}
            ],
            itemStyle: {
                normal: {
                    label: {
            ...
            color: ['#FDC008', '#0F77FF'],
            data: [
                // {value: 10, name: '夜班', id: 0},
                // {value: 10, name: '公出', id: 1},
                // {value: 5, name: '请假', id: 2},
                // {value: 70, name: '在线', id: 3}
                {value: 10, name: '在线', id: 0},
                {value: 40, name: '离线', id: 1}
            ],
            itemStyle: {
                normal: {
                    label: {
...
function Coincidence1() {
    // 1. 实例化对象
    var myChart = echarts.init(document.querySelector("#workareas"));
    //  准备数据
    // 2. 指定配置和数据
    var option = {
        color: ["#00f2f1", "#ed3f35"],
...
function Coincidence() {
    // 1. 实例化对象
    var myChart = echarts.init(document.querySelector("#teamworks"));
    //  准备数据
...
function workradio() {
    ...
    var option = {
        ...
        series: {
            ...
            data: [64, 86, 40, 73, 56, 63, 41, 46, 90, 63, 81, 52]
        },
    };
